...
plot.phylo(root(rax_tree$bestTree,"chlorocebus_sabaeus"))

finalrates<-geneinfo(root(rax_tree$bestTree,"chlorocebus_sabaeus"))
suminfo(finalrates,root(rax_tree$bestTree,"chlorocebus_sabaeus"))
